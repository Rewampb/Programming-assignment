...
const resultTall = multipliser(tall);
const resultAndreTall = multipliser(andreTall);

console.log("Product of tall: ", resultTall);
console.log("Product of andreTall: ", resultAndreTall);
